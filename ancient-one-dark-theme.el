;;; ancient-one-dark-theme.el --- A color theme based off uetchy's Ancient One Dark Theme -*- lexical-binding: t; -*- 
...
;;; Code:
 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'ancient-one-dark
	...
	;; Centaur tabs
	`(centaur-tabs-selected ((,class (:background ,bg1))))
	`(centaur-tabs-unselected ((,class (:background ,bg2))))
	`(fringe ((,class (:background ,bg1 :foreground ,fg4))))
	`(cursor ((,class (:background ,bg3))))
        `(show-paren-match-face ((,class (:background ,warning))))
        `(isearch ((,class (:bold t :foreground ,warning :background ,bg3))))
        `(mode-line ((,class (:box (:line-width 3 :color ,bg2) :bold t :foreground ,fg2 :background ,bg2))))
        `(mode-line-inactive ((,class (:box (:line-width 1 :color ,bg2 :style pressed-button) :foreground ,var :background ,bg1 :weight normal))))
        `(mode-line-buffer-id ((,class (:bold t :foreground ,func :background nil))))
	`(mode-line-highlight ((,class (:foreground ,keyword :box nil :weight bold))))
        `(mode-line-emphasis ((,class (:foreground ,fg4))))
  ...
  (when (>= emacs-major-version 27)
    (custom-theme-set-faces
     ...
     `(tab-line ((,class (:inherit fringe :box (:line-width 5 :color ,bg1)))))
...
(provide-theme 'ancient-one-dark)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; ancient-one-dark-theme.el ends here
